...
3. breathing_distortion.py imports configurations created by Ising.out 
...
4. ising.ipynb contains functions used for analysis of short-range order  
   created by ising model simulation 

5. To calculate diffuse scattering in the L=1/2 plane use diffuse.ipynb to import
