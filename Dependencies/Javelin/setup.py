...
extensions = [Extension('javelin.fourier_cython', ['javelin/fourier_cython.pyx'],
             ...
             Extension('javelin.energies', ['javelin/energies.pyx'],
                        include_dirs=[numpy.get_include()], define_macros=macros, extra_compile_args = flags),
             Extension('javelin.mccore', ['javelin/mccore.pyx'],
                        include_dirs=[numpy.get_include()], define_macros=macros, extra_compile_args = flags),
             Extension('javelin.modifier', ['javelin/modifier.pyx'],
                        include_dirs=[numpy.get_include()], define_macros=macros, extra_compile_args = flags),
             Extension('javelin.random', ['javelin/random.pyx'],
                        define_macros=macros, extra_compile_args = flags),
             Extension('custom.energies', ['custom/energies.pyx'],
						include_dirs=[numpy.get_include()], define_macros=macros, extra_compile_args = flags)
